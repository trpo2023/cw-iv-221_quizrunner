...
void create_questions(question_t* questions)
{
    questions[0].question
            = "Какой тип данных используется для хранения целочисленных "
              "значений?";
    ...
    questions[5].question
            = "Как называется цикл, который выполняется до тех пор, пока не "
              "выполнится определенное условие?";
    questions[5].answer = "while";
    questions[6].question
            = "Каким символом обозначается комментарий в языке Си?";
    questions[6].answer = "//";
    questions[7].question
            = "Какой тип данных может хранить только два значения: true и "
              "false?";
    questions[7].answer = "bool";
    questions[8].question
            = "Как называется оператор, который используется для считывания "
              "данных с консоли?";
